...
- Local-first privacy model: no backend, no accounts, no telemetry, no translation
  history. Text is sent directly from your machine to Google Cloud over HTTPS only
  when you explicitly translate. The API key lives in GNOME Keyring.
...
- No automatic translation while typing
